        ...
        <div className=" py-20 flex flex-col place-items-center mt-20 " id="nftForm" >
            ...
            <h3 className=" text-center font-bold mb-8 text-[rgb(12,13,38)] ">Upload Voucher here</h3>
                ...
                <div className="mb-6">
                    ...
                    <input className="bg-white hover:bg-green-50 shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" type="value" placeholder="in ETH" step="0.01" value={formParams.price} onChange={e => updateFormParams({...formParams, price: e.target.value})}></input>
                </div>
                <div>
